...
import { UpdateProfileInput, UpdateProfilePreferencesInput, ProfileResponse, ProfilePreferencesResponse } from "./profile.types";
...
export class ProfileService{
    ...
    async updateProfilePreferences(
        ...
        if(input.preferredLanguageId){
            const programmingLanguage = await this.profileRepository.findProgrammingLanguage(input.preferredLanguageId);
