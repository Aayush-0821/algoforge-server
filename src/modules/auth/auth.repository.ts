...
export class AuthRepository {
  ...
  async updatePasswordResetToken(id: string, data: Prisma.PasswordResetTokenUpdateInput) {
  ...
  async findOAuthAccount(provider: "GOOGLE" | "GITHUB", providerAccountId: string) {
