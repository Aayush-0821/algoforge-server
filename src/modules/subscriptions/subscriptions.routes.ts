...
router.get("/plans/:planId", subscriptionController.getPlan.bind(subscriptionController));

router.post(
  "/calculate",
  authMiddleware,
  validate(createSubscriptionSchema),
  subscriptionController.calculateSubscriptionPrice.bind(subscriptionController),
);
...
router.post(
  ...
  subscriptionController.validatePromoCode.bind(subscriptionController),
);
